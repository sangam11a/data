...
void Byte_Write_4B(SPI_HandleTypeDef *SPI,uint32_t address, uint8_t
		data);
/* Erase operations */
...
#ifndef DRIVERS_FLASH_MT25QL_H_
#define DRIVERS_FLASH_MT25QL_H_



#endif /* DRIVERS_FLASH_MT25QL_H_ */
